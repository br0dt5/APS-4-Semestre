 ...
 * @author davig
 */
public class TelaInsertionSort extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaInsertionSort.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
